    ...
    return (
      <div className="mt-8 text-center" aria-live="polite">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Your driver password has been updated. You can now sign in with your new password.
        </p>
        <Link
  ...
  if (step === "SET_PASSWORD") {
    return (
      <form className="mt-8 space-y-5" onSubmit={handleResetPassword}>
        ...
        <button
          className="flex h-12 w-full items-center justify-center gap-2 rounded-full bg-secondary px-5 text-sm font-bold text-secondary-foreground hover:bg-secondary/90 disabled:opacity-50"
          disabled={loading}
          type="submit"
        >
  ...
  return (
    <form className="mt-8" onSubmit={handleVerifyOtp}>
      ...
      <div className="mt-5 flex items-center justify-between text-xs">
        ...
        <button
          className="font-bold text-foreground hover:underline disabled:opacity-50"
          type="button"
          disabled={resending}
      ...
      <button
        className="mt-7 flex h-12 w-full items-center justify-center gap-2 rounded-full bg-secondary px-5 text-sm font-bold text-secondary-foreground hover:bg-secondary/90 disabled:opacity-50"
...
function maskEmail(email: string) {
  ...
  const [name = "driver", domain = "email.com"] = email.split("@");
